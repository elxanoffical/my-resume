  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="/"
          className="w-10 h-10 rounded-xl bg-neutral-100 dark:bg-neutral-700/40 flex items-center justify-center mb-4 
        ...
        <div className="grid grid-cols-2 gap-4 p-5 rounded-[22px] border border-neutral-100 dark:border-neutral-700/50 bg-white dark:bg-neutral-800/10 mb-2">
          <div>
            <p className="text-[11px] text-neutral-300 font-bold uppercase mb-1">
              Industry
            </p>
            <p className="text-[14px] font-semibold dark:text-neutral-400">
              {project.industry}
            </p>
          </div>
          <div>
        ...
        <div className="gap-4 p-5 rounded-[22px] border border-neutral-100 dark:border-neutral-700/50">
          <p className="text-[11px] text-neutral-300 font-bold uppercase ">
            Description
          </p>
      ...
      <div className="space-y-4 mb-2">
        <div className="p-4 rounded-[28px] border border-neutral-200 bg-white dark:bg-neutral-800/60 dark:border-neutral-800 shadow-sm">
          <p className="text-[11px] font-bold text-neutral-400 uppercase tracking-widest mb-4 px-2">
            Next Project
          </p>
